...
// async function getOrdonnanceHTML(ordonnance, patient, medecinTraitant) {
...
//     : "Non renseignée";
//   const telephone = patient?.telephone || "Non renseigné";
//   const mutuelle = patient?.mutuelle || "Non renseignée";
  
//   // Informations du médecin traitant
//   const medecinNom = medecinTraitant 
//     ? `Dr ${medecinTraitant.nom} ${medecinTraitant.prenom}`
//     : "Non renseigné";
//   const medecinSpecialite = medecinTraitant?.specialite || "";
//   const medecinTel = medecinTraitant?.telephone || "";
...
//           <div style="font-size: 14px; font-weight: bold; color: #2c7da0; margin-top: 5px;">${cabinetInfos.medecinCabinet}</div>
//         </div>
//       </div>
//       <div style="font-size: 11px; color: #666;">${cabinetInfos.adresse}</div>
//       <div style="font-size: 10px; color: #888;">📞 ${cabinetInfos.telephone} | ✉️ ${cabinetInfos.email}</div>
//     </div>
...
//           <div style="font-size: 13px; font-weight: bold; color: #333;">${medecinNom}</div>
//           ${medecinSpecialite ? `<div style="font-size: 10px; color: #666;">${medecinSpecialite}</div>` : ''}
//         </div>
//         ${medecinTel ? `<div style="font-size: 10px; color: #666;">📞 ${medecinTel}</div>` : ''}
//       </div>
//     </div>
...
//         </div>
//         <div>
//           <div style="font-size: 10px; color: #666;">Mutuelle</div>
//           <div style="font-size: 12px; color: #333;">${mutuelle}</div>
//         </div>
//       </div>
...
//     <div style="margin-bottom: 20px; border: 1px solid #e0e0e0; border-radius: 8px; overflow: hidden;">
//       <div style="background: #0f5b7a; color: white; padding: 10px 15px; font-weight: bold;">⏰ POSOLOGIE</div>
...
//         <div style="font-size: 11px; color: #0f5b7a; font-weight: bold;">${cabinetInfos.medecinCabinet}</div>
//         <div>_________________</div>
//         <div style="font-size: 9px; color: #999; margin-top: 5px;">Signature & Cachet</div>
//       </div>
//     </div>
...
// export async function generateOrdonnancePDF(ordonnance, patient, medecinTraitant) {
//   const element = await getOrdonnanceHTML(ordonnance, patient, medecinTraitant);
...
// export async function downloadOrdonnancePDF(ordonnance, patient, medecinTraitant) {
//   const pdf = await generateOrdonnancePDF(ordonnance, patient, medecinTraitant);
...
// export async function previewOrdonnancePDF(ordonnance, patient, medecinTraitant) {
//   const pdf = await generateOrdonnancePDF(ordonnance, patient, medecinTraitant);
...
//   // Information du médecin traitant (VENANT DE LA BASE DE DONNÉES)
//   const medecinNom = medecinTraitant 
//     ? `Dr ${medecinTraitant.nom} ${medecinTraitant.prenom}`
//     : "Non renseigné";
//   const medecinSpecialite = medecinTraitant?.specialite || "";
...
//   // Médecin prescripteur (celui qui est connecté et signe l'ordonnance)
//   // Ceci devrait venir de l'utilisateur connecté, pas d'une variable fixe
//   const medecinPrescripteur = cabinetInfos.medecinPrescripteur || cabinetInfos.nom;
...
//     <!-- MÉDECIN TRAITANT (venant de la base) -->
//     <div style="background: #e8f4f0; padding: 10px 15px; border-radius: 8px; margin-bottom: 15px; border-left: 4px solid #2c7a4d;">
//       <div style="display: flex; justify-content: space-between; align-items: center;">
//         <div>
//           <span style="font-size: 10px; color: #2c7a4d; font-weight: bold;">MÉDECIN TRAITANT</span>
...
//       <div style="width: 180px; text-align: center; margin-left: auto;">
//         <div>_________________</div>
//         <div style="font-size: 9px; color: #999; margin-top: 5px;">Signature & Cachet du médecin</div>
//       </div>
//     </div>
...
//   // Information du médecin prescripteur (celui qui signe l'ordonnance)
...
//     <!-- MÉDECIN TRAITANT (celui qui suit le patient) -->
//     <div style="background: #e8f4f0; padding: 10px 15px; border-radius: 8px; margin-bottom: 15px; border-left: 4px solid #2c7a4d;">
//       <div style="display: flex; justify-content: space-between; align-items: center;">
//         <div>
//           <span style="font-size: 10px; color: #2c7a4d; font-weight: bold;">MÉDECIN TRAITANT</span>
...
//         </div>
//         ${medecinTraitantTel ? `<div style="font-size: 10px; color: #666;">📞 ${medecinTraitantTel}</div>` : ''}
//       </div>
//     </div>
...
//     <!-- ZONE SIGNATURE AVEC NOM DU MÉDECIN PRESCRIPTEUR -->
//     <div style="margin-top: 40px; text-align: right; border-top: 1px dashed #ccc; padding-top: 30px;">
//       <div style="width: 220px; text-align: center; margin-left: auto;">
//         <div style="font-size: 12px; font-weight: bold; color: #0f5b7a; margin-bottom: 5px;">
//           ${medecinPrescripteurNom}
//         </div>
//         <div>_________________</div>
//         <div style="font-size: 9px; color: #999; margin-top: 5px;">Signature & Cachet du médecin</div>
//       </div>
...
async function getOrdonnanceHTML(ordonnance, patient, medecinTraitant, medecinPrescripteur) {
  ...
  div.innerHTML = `
    ...
    <!-- ZONE SIGNATURE AVEC LE NOM DU MÉDECIN TRAITANT ET SA SIGNATURE DESSINÉE -->
    <div style="margin-top: 40px; text-align: right; border-top: 1px dashed #ccc; padding-top: 30px;">
