 ...
 *
 * CHANGELOG :
 *   patients.comptable : 'none' → 'read'
 *     Raison : le comptable doit voir les noms des patients liés aux factures
 *     et pouvoir faire l'export comptable. Il n'a PAS le droit de créer,
 *     modifier ou supprimer un patient (pas de 'write').
 */
export const PERMISSIONS = {
  // Tableau de bord
  dashboard:     { superadmin:'admin',  medecin:'admin',  secretaire:'read',  comptable:'read',  assistant:'read'  },
  ...
  // Patients  ← MODIFIÉ : comptable passe de 'none' à 'read'
  patients:      { superadmin:'admin',  medecin:'write',  secretaire:'write', comptable:'read',  assistant:'read'  },
...
export function isAdmin(role, module) {
  return getPermission(role, module) === 'admin'
}
